...
public class ServiceTester {
    ...
    public ServiceTester(File setupFolder, File springFolder, File storiesFolder, File compositeStepsFolder, File filesFolder) {
        ...
        sysPropInjector.registerSystemProperty("filesFolder", this.filesFolder.getAbsolutePath().replace("\\", "/"), "main");
        sysPropInjector.registerSystemProperty("setupFolder", this.setupFolder.getAbsolutePath().replace("\\", "/"), "main");
    }
